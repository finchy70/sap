@props(['initialValue' => '', 'name' => '', 'label' => "", 'upload'=> "", 'endpoint' => "", 'delete-endpoint' => ""])
{{--<div class="mt-2"--}}
{{--     wire:ignore--}}
{{--     {{ $attributes }}--}}
{{--     x-data--}}
...
{{-->--}}
{{--    <textarea {{ $attributes }} rows="5" class="form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"></textarea>--}}
...
{{--         @js-errors.window="error = $event.detail.errors.{{ $name }} || ''"--}}
        ...
        <trix-editor
            ...
            x-ref="trix-editor"
            x-on:trix-blur="$dispatch('input', event.target.value)"
