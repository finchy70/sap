                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                            <div class="flex row justify-between items-center">
                                ...
                                @if(auth()->user()->admin)
                                    <a href="{{route('new-message')}}" class="bg-green-400 text-gray-800 px-2 py-1 text-xs rounded-lg shadow-lg">New</a>
                                @endif
                            </div>
                        ...
                        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                            ...
                            <div class="mt-8 p-2 bg-gray-100 rounded-xl">
                                ...
                                <div class="row flex">
                                    ...
                                    @if(auth()->user()->admin)
                                        <button class="ml-2 mt-2 px-2 py-1 bg-indigo-500 text-gray-100 rounded-lg shadow-lg text-xs">Upload</button>
                                    @endif
                                </div>
